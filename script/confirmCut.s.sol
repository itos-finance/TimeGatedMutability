...
/// Example script for confirming a cut after initializing it with initCut.s.sol and waiting the required duration.
contract ConfirmCutScript is Script {
    function run() public {
        ...
        ITimedDiamondCut(diamond).confirmCut(assignmentId);
